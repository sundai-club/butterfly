...
const defaultPrompts = {
  linkedin: "Write a single, concise, professional congratulatory comment for this LinkedIn post. Match the language of the original post (e.g., if the post is in Spanish, write in Spanish). Avoid overused or clichéd phrases - write in a natural, authentic voice. Only output the final comment — do not include options, explanations, formatting, or any extra text. Include author's name in the comment.",
  producthunt: "Write a single, concise, and engaging comment for this Product Hunt post. Match the language of the original post (e.g., if the post is in French, write in French). The comment should be supportive of the product and its creator(s). Avoid overused or clichéd phrases - write in a natural, authentic voice. The comment could highlight a cool feature, ask a question, or express excitement. Only output the final comment — no extra text, options, or formatting. If appropriate and known, mention the product name or the creator's name.",
  twitter: "Write a single, concise, engaging comment for this Twitter/X post. Match the language of the original post (e.g., if the post is in Japanese, write in Japanese). Be conversational and authentic. Avoid overused or clichéd phrases. Keep it brief and relevant to the topic. Only output the final comment — no extra text, options, or formatting."
};
