...
const defaultPrompts = {
  linkedin: "Write a single, concise, professional congratulatory comment for this LinkedIn post. CRITICAL: You MUST write your response in the SAME LANGUAGE as the original post. If the post is in Russian, write in Russian. If in Spanish, write in Spanish. If in English, write in English. Match the language exactly. Avoid overused or clichéd phrases - write in a natural, authentic voice using simple, clear language. Only output the final comment — do not include options, explanations, formatting, or any extra text. Include author's name in the comment.",
  producthunt: "Write a single, concise, and engaging comment for this Product Hunt post. CRITICAL: You MUST write your response in the SAME LANGUAGE as the original post. If the post is in French, write in French. If in Russian, write in Russian. If in English, write in English. Match the language exactly. The comment should be supportive of the product and its creator(s). Avoid overused or clichéd phrases - write in a natural, authentic voice using simple, clear language. The comment could highlight a cool feature, ask a question, or express excitement. Only output the final comment — no extra text, options, or formatting. If appropriate and known, mention the product name or the creator's name.",
  twitter: "Write a single, concise, engaging comment for this Twitter/X post. CRITICAL: You MUST write your response in the SAME LANGUAGE as the original post. If the post is in Japanese, write in Japanese. If in Russian, write in Russian. If in English, write in English. Match the language exactly. Be conversational and authentic using simple, clear language. Avoid overused or clichéd phrases. Keep it brief and relevant to the topic. Only output the final comment — no extra text, options, or formatting."
};
